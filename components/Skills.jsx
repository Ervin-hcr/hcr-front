...
export default function Services() {
  ...
  return (
    <section className="p-6 background-beige">
      <h2 className="text-3xl color-text font-bold mb-6 text-center">Nos savoir-faire à votre service</h2>
      <p className="text-xl mb-6 text-center">Chez H.C.R, nous mettons notre expertise au service de tous vos projets de rénovation. Chaque métier est pris en charge par des professionnels qualifiés pour garantir un résultat soigné, durable et à votre image.</p>

      <div className="grid gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
       {services.map((serviceItem) => {
  const { id, service, description, image } = serviceItem;

  // ⚡ Récupération correcte de l'image depuis le tableau
